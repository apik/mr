  ...
  SECTION( "Real arguments" )
    {
      ...
      std::complex<long double> li2 = mr::Li2( std::complex<long double>(1,0) );
      REQUIRE( li2.real() == Approx( 1.64493 ) );
      REQUIRE( li2.imag() == Approx( 0 ) );

      std::complex<long double> li3 = mr::Li3( std::complex<long double>(1,0) );
  ...
  SECTION( "Imaginary arguments" )
    {
      ...
      std::complex<long double> li2 = mr::Li2( std::complex<long double>(0,1) );
      REQUIRE( li2.real() == Approx( -0.205617 ) );
      REQUIRE( li2.imag() == Approx( 0.915966 ) );

      std::complex<long double> li3 = mr::Li3( std::complex<long double>(0,1) );
  ...
  SECTION( "Complex arguments" )
    {
      ...
      std::complex<long double> li2 = mr::Li2( std::complex<long double>(1,1) );
      REQUIRE( li2.real() == Approx( 0.61685 ) );
      REQUIRE( li2.imag() == Approx( 1.46036 ) );

      std::complex<long double> li3 = mr::Li3( std::complex<long double>(1,1) );
