      ...
      for (int mHi = 0; mHi < 4; mHi++)
        {
          ...
          plotLam.add(BKKS.MH(),
                      ...
                      alpha(BKKS.Mt())/4./Pi*alphaSMt/4./Pi*dH.my11().real(),
                      alpha(BKKS.Mt())/4./Pi*dH.my10().real()+
                      alpha(BKKS.Mt())/4./Pi*alphaSMt/4./Pi*dH.my11().real(),
                      alpha(BKKS.Mt())/4./Pi*dH.my10().real()+
                      alpha(BKKS.Mt())/4./Pi*alphaSMt/4./Pi*dH.my11().real()+
                      pow(alpha(BKKS.Mt())/4./Pi,2)*dH.my20().real());
          ...
          plotDegr.add(BKKS.MH(),
                       ...
                       (1+
                        alpha(BKKS.Mt())/4./Pi*dH.my10().real()+
                        alpha(BKKS.Mt())/4./Pi*alphaSMt/4./Pi*dH.my11().real()+
                        pow(alpha(BKKS.Mt())/4./Pi,2)*dH.my20().real())*BKKS.MMH()*1.16637e-5/sqrt(2),
                       (0.12711+0.00206*(BKKS.MH()-125.66)-0.00004*(BKKS.Mt()-173.10))
                       );
          
          plotDegrPart.add(BKKS.MH(),
                       alphaMt/4./Pi*alphaSMt/4./Pi*dH.my11().real()                  
                       *BKKS.MMH()*1.16637e-5/sqrt(2),
                       pow(alphaMt/4./Pi,2)*dH.my20().real()*BKKS.MMH()*1.16637e-5/sqrt(2),
