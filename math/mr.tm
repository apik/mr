...
:Evaluate:  P2MS::usage  = "P2MS[Mb,MW,MZ,MH,Mt,scale] return running couplings at fixed scale for pole masses input, default options are asMZ -> 0.1185, EW->2, Mixed->2, QCD->4. This mean number of loops to include in evaluation of each contribution."
...
// P2MS
:Evaluate:  Options[P2MS] = { "EW" -> 2, "Mixed" -> 2, "QCD" -> 4, "asMZ" -> 0.1185};

:Evaluate:  P2MS[Mb_?NumericQ,MW_?NumericQ,MZ_?NumericQ,MH_?NumericQ,Mt_?NumericQ,scale_?NumericQ, OptionsPattern[]] := P2MSimpl[Mb,MW,MZ,MH,Mt,scale,OptionValue["asMZ"],OptionValue["EW"],OptionValue["Mixed"],OptionValue["QCD"]]
...
:Pattern: P2MSimpl[Mb_?NumericQ,MW_?NumericQ,MZ_?NumericQ,MH_?NumericQ,Mt_?NumericQ,scale_?NumericQ,asMZ_?NumericQ,lEW_Integer:2,lMixed_Integer:2,lQCD_Integer:4]
:Arguments: {N[Mb],N[MW],N[MZ],N[MH],N[Mt],N[scale],N[asMZ],lEW,lMixed,lQCD}
:ArgumentTypes: {Real128,Real128,Real128,Real128,Real128,Real128,Real128,Integer,Integer,Integer}
:ReturnType: Manual
:End:
