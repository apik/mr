...
void XW P(( double _tp1, double _tp2, double _tp3, double _tp4, double _tp5, double _tp6));
...
#endif
{
	...
	XW(_tp1, _tp2, _tp3, _tp4, _tp5, _tp6);
...
#endif
{
	int _res;
	_res = MLConnect(mlp);
	if (_res) _res = _definepattern(mlp, (char *)"X[W][mb_?NumericQ,mW_?NumericQ,mZ_?NumericQ,mH_?NumericQ,mt_?NumericQ,mu2_?NumericQ]", (char *)"{N[mb],N[mW],N[mZ],N[mH],N[mt],N[mu2]}", 0);
