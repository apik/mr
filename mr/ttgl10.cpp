...
{     
    ...
    mttgl[2]=pow(SW,-1);
    mttgl[3]=pow(MMW,-1);
    mttgl[4]=Tsil::B(0,0,MMt,mu2);
    mttgl[5]=Tsil::A(MMH,mu2);
    mttgl[6]=Tsil::A(MMt,mu2);
    mttgl[7]=pow(MMH,-1);
   mttgl[8]=1./2.*mttgl[1];
   mttgl[9]=mttgl[6]*mttgl[7];
   mttgl[9]=mttgl[8] + 1./8.*mttgl[4] - 3*mttgl[9];
   mttgl[9]=MMt*mttgl[9];
   mttgl[8]= - MMH*mttgl[8];
   mttgl[8]=mttgl[8] + mttgl[6] + mttgl[5];
